...
ip netns exec vlan_test ip link set bond0.100 address 02:ac:10:ff:02:13
ip netns exec vlan_test ip link set bond0.100 up
ip netns exec vlan_test ip link set bond0.100 mtu 1500
ip netns exec vlan_test ip addr add 10.0.100.3/24 dev bond0.100
...
ip netns exec qinq_test_1000_10 ip link set bond0.1000.10 address 02:ac:10:ff:02:14
ip netns exec qinq_test_1000_20 ip link set bond0.1000.20 address 02:ac:10:ff:02:15
...
ip netns exec qinq_test_1000_10 ip addr add 10.100.10.3/24 dev bond0.1000.10
ip netns exec qinq_test_1000_20 ip addr add 10.100.20.3/24 dev bond0.1000.20
